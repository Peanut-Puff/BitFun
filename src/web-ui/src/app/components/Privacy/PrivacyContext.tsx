...
interface PrivacyContextValue {
  ...
  markViewed: (policyVersion: string, locale: string) => Promise<PrivacyStatus>;
...
export const PrivacyProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const markViewed = useCallback(
    (policyVersion: string, locale: string) =>
      update(() => privacyAPI.markViewed(policyVersion, locale)),
    [update],
  );
